...
interface Creep extends RoomObject {
    ...
    type: string;
    myBuildings: Array<OwnedStructure>;
    myBuildingsAreFull: boolean;
    mySource: Source;
    sourceIndex: number;
    doAction(): ScreepsReturnCodecode;
    /**
 ...
 */
interface Game {
    identifyCreeps(): ScreepsReturnCode;
    update(): ScreepsReturnCode;
    memory: GameMemory;
    creepsToIdentify: string[];
    identifiedCreeps: {[id: string]: string};
    /**
...
interface Mission {
    ...
    hash: number;
    beClaimed(creep: Creep);
    static encode(mission: Mission): string[];
    static decode(args: string[]): Mission
}

interface SubMission {
    target: Source|Structure|Creep|ConstructionSite|RoomPosition|number;
    actionString: string;
    room?: string;
    resource?: string
    static encode(subMission: SubMission): string[];
    static decode(args: string[]): SubMission
...
interface Room {
    ...
    scanEventLog(): void;
    reactToTick(): void;
    scanExistingBuildings(): void;
    drainStorage(): void;
    sources: Source[];
    isFullEnergy: boolean;
    spawn: StructureSpawn;
    orientation: DirectionConstant;
    blueprint: Blueprint;
    /**
...
interface Source extends RoomObject {
    ...
    spawnToSource: PathStep[];
    mover: Creep;
    harvester: Creep;
    upgrader: Creep;
    transferer: Creep;
    builder: Creep;
    recycleEnergyDrop?: Resource;
    sourceEnergyDrop?: Resource;
    spawnEnergyDrop?: Resource;
    link?: StructureLink;
    needsHarvesterMoving: boolean;
    needsUpgraderMoving: boolean;
    hasLink: boolean;
...
interface StructureSpawn extends OwnedStructure<STRUCTURE_SPAWN> {
    ...
    reactToTick(): void;
    getSpawningPosition(cellRef: number): RoomPosition;
    isDirectionOccupied(spawningPosition: RoomPosition): boolean;
    doTheSpawn(type: string, sourceIndex: number, targetedRoomName: string, spawningPosition: RoomPosition, carryPartsQty: number, worksPartsQty: number, movePartsQty: number, claimPartsQty: number):ScreepsReturnCode;
    smartSpawn(type: string, sourceIndex: number, targetedRoomName?: string): ScreepsReturnCode;
    ttl: number;
 ...
 */
interface Blueprint {
    readonly prototype: Blueprint;
    getPos(cellRef: number): RoomPosition;
    reactToTick(): void;
    memory: Object;
    currentConstructionSite?: ConstructionSite;
    link1Pos: RoomPosition;
    link2Pos: RoomPosition;
    tower?: StructureTower;
    energyDrop?: Resource;
    spawn2?: StructureSpawn;
    isBeingRebooted: boolean;
    ext1?: StructureExtension;
    ext2?: StructureExtension;
    ext3?: StructureExtension;
    ext4?: StructureExtension;
    ext5?: StructureExtension;
    ext6?: StructureExtension;
    ext7?: StructureExtension;
    ext8?: StructureExtension;
    ext9?: StructureExtension;
    ext10?: StructureExtension;
    ext11?: StructureExtension;
    ext12?: StructureExtension;
    ext13?: StructureExtension;
    link0?: StructureLink;
    link1?: StructureLink;
    link2?: StructureLink;
    container0?: StructureContainer;
    storage?: StructureStorage;
    buildingsPerLevel: Array<Array<Array<OwnedStructure | RoomPosition | BuildableStructureConstant | string>>>;
}
